...
const (
	...
	RESUME_URL   = "https://nakul.one/resume" 
 	GITHUB_URL   = "https://github.com/Spitfire1970"
	LINKEDIN_URL = "https://www.linkedin.com/in/nakul404/"
	LEETCODE_URL  = "https://leetcode.com/u/Spitfire1970"
)
...
func openByChoice(m model) (tea.Model, tea.Cmd) {
	...
	case 3:
		return m, openURL(m, LEETCODE_URL)
	}
	return m, nil
}
